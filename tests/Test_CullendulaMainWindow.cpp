...
void Test_CullendulaMainWindow::slot_Test_VersionMetadata_IsDocumentedConsistently() {
    ...
    QVERIFY(cmakeContents.contains("VERSION 0.7.1"));
    ...
    QVERIFY(readmeContents.contains("This is version 0.7.1."));
    ...
    QVERIFY(changelogContents.contains("* v0.7.1 fixes the path comparison that made the application lose the selected image"));
}
