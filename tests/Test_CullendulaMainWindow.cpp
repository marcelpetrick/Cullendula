...
void Test_CullendulaMainWindow::slot_Test_VersionMetadata_IsDocumentedConsistently() {
    ...
    QVERIFY(cmakeContents.contains("VERSION 0.7.20"));
    ...
    QVERIFY(readmeContents.contains("This is version 0.7.20."));
    ...
    QVERIFY(changelogContents.contains("* v0.7.20 runs the unit suite on Windows in CI"));
}
