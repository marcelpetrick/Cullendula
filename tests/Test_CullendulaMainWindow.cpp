...
void Test_CullendulaMainWindow::slot_Test_VersionMetadata_IsDocumentedConsistently() {
    ...
    QVERIFY(cmakeContents.contains("VERSION 0.7.9"));
    ...
    QVERIFY(readmeContents.contains("This is version 0.7.9."));
    ...
    QVERIFY(changelogContents.contains("* v0.7.9 installs the pinned CMake release"));
}
