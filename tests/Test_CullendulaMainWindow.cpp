...
void Test_CullendulaMainWindow::slot_Test_VersionMetadata_IsDocumentedConsistently() {
    ...
    QVERIFY(cmakeContents.contains("VERSION 0.6.41"));
    ...
    QVERIFY(readmeContents.contains("This is version 0.6.41."));
    ...
    QVERIFY(changelogContents.contains("* v0.6.41 moves the version history out of the README"));
}
