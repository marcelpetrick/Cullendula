...
void Test_CullendulaMainWindow::slot_Test_VersionMetadata_IsDocumentedConsistently() {
    ...
    QVERIFY(cmakeContents.contains("VERSION 0.7.16"));
    ...
    QVERIFY(readmeContents.contains("This is version 0.7.16."));
    ...
    QVERIFY(changelogContents.contains("* v0.7.16 restores QT_QPA_PLATFORM"));
}
