...
void Test_CullendulaMainWindow::slot_Test_VersionMetadata_IsDocumentedConsistently() {
    ...
    QVERIFY(cmakeContents.contains("VERSION 0.6.46"));
    ...
    QVERIFY(readmeContents.contains("This is version 0.6.46."));
    ...
    QVERIFY(changelogContents.contains("* v0.6.46 drops Qt image format plugins whose system libraries the build image cannot satisfy"));
}
