...
void Test_CullendulaMainWindow::slot_Test_VersionMetadata_IsDocumentedConsistently() {
    ...
    QVERIFY(cmakeContents.contains("VERSION 0.7.0"));
    ...
    QVERIFY(readmeContents.contains("This is version 0.7.0."));
    ...
    QVERIFY(changelogContents.contains("* v0.7.0 releases ready-to-run packages for both desktop platforms"));
}
