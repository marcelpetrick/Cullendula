...
void Test_CullendulaMainWindow::slot_Test_VersionMetadata_IsDocumentedConsistently() {
    ...
    QVERIFY(cmakeContents.contains("VERSION 0.8.0"));
    ...
    QVERIFY(readmeContents.contains("This is version 0.8.0."));
    ...
    QVERIFY(changelogContents.contains("* v0.8.0 rounds off the overhaul"));
}
