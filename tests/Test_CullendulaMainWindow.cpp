...
void Test_CullendulaMainWindow::slot_Test_VersionMetadata_IsDocumentedConsistently() {
    ...
    QVERIFY(cmakeContents.contains("VERSION 0.7.11"));
    ...
    QVERIFY(readmeContents.contains("This is version 0.7.11."));
    ...
    QVERIFY(changelogContents.contains("* v0.7.11 renames the CTest unit-suite entry"));
}
