...
void Test_CullendulaMainWindow::slot_Test_VersionMetadata_IsDocumentedConsistently() {
    ...
    QVERIFY(cmakeContents.contains("VERSION 0.6.45"));
    ...
    QVERIFY(readmeContents.contains("This is version 0.6.45."));
    ...
    QVERIFY(changelogContents.contains("* v0.6.45 adds a tag-triggered release workflow"));
}
