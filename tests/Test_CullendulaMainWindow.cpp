...
void Test_CullendulaMainWindow::slot_Test_VersionMetadata_IsDocumentedConsistently() {
    ...
    QVERIFY(cmakeContents.contains("VERSION 0.6.44"));
    ...
    QVERIFY(readmeContents.contains("This is version 0.6.44."));
    ...
    QVERIFY(changelogContents.contains("* v0.6.44 adds install rules plus a desktop entry, an icon and AppStream metainfo"));
}
