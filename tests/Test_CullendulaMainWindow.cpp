...
void Test_CullendulaMainWindow::slot_Test_VersionMetadata_IsDocumentedConsistently() {
    ...
    QVERIFY(cmakeContents.contains("VERSION 0.6.47"));
    ...
    QVERIFY(readmeContents.contains("This is version 0.6.47."));
    ...
    QVERIFY(changelogContents.contains("* v0.6.47 bundles the offscreen and Wayland platform plugins into the AppImage"));
}
