...
void Test_CullendulaMainWindow::slot_Test_VersionMetadata_IsDocumentedConsistently() {
    ...
    QVERIFY(cmakeContents.contains("VERSION 0.7.3"));
    ...
    QVERIFY(readmeContents.contains("This is version 0.7.3."));
    ...
    QVERIFY(changelogContents.contains("* v0.7.3 lets each test object write its own report"));
}
