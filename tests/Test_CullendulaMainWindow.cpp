...
void Test_CullendulaMainWindow::slot_Test_VersionMetadata_IsDocumentedConsistently() {
    ...
    QVERIFY(cmakeContents.contains("VERSION 0.7.2"));
    ...
    QVERIFY(readmeContents.contains("This is version 0.7.2."));
    ...
    QVERIFY(changelogContents.contains("* v0.7.2 captures the whole Windows unit test console"));
}
