...
void Test_CullendulaMainWindow::slot_Test_VersionMetadata_IsDocumentedConsistently() {
    ...
    QVERIFY(cmakeContents.contains("VERSION 0.7.12"));
    ...
    QVERIFY(readmeContents.contains("This is version 0.7.12."));
    ...
    QVERIFY(changelogContents.contains("* v0.7.12 embeds the application icon"));
}
