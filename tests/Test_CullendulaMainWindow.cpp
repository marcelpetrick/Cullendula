...
void Test_CullendulaMainWindow::slot_Test_VersionMetadata_IsDocumentedConsistently() {
    ...
    QVERIFY(cmakeContents.contains("VERSION 0.7.17"));
    ...
    QVERIFY(readmeContents.contains("This is version 0.7.17."));
    ...
    QVERIFY(changelogContents.contains("* v0.7.17 raises the line-coverage gate to 95%"));
}
